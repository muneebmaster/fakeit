...
export function parseModelFunctions(model, babel_config = {}) {
  ...
  paths.forEach((function_path) => {
    ...
    fn = `function __result(documents, globals, inputs, faker, chance, moment, document_index, require) {\n${fn}\n}`;
    ...
    fn = [
      `function ${name}(_documents, _globals, _inputs, _faker, _chance, _moment, _document_index, _require) {`,
        // indent each line and create a string
